class Constants {
  static const String WEATHER_APP_ID = '444ce36b892da1dd0794950d4752c83b';
  static const String WEATHER_BASE_SCHEME = 'https://';
  static const String WEATHER_BASE_URL_DOMAIN = 'api.openweathermap.org';
  static const String WEATHER_FORECAST_PATH_FORECAST = '/data/2.5/forecast';
  static const String WEATHER_FORECAST_PATH_CURRENT = '/data/2.5/weather';
